...
function fluida_body_classes($classes)
{
	...
	if ($options['fluida_magazinelayout']) {
		switch ($options['fluida_magazinelayout']):
			case 1:
				$classes[] = 'fluida-magazine-one fluida-magazine-layout';
				break;
			case 2:
				$classes[] = 'fluida-magazine-two fluida-magazine-layout';
				break;
			case 3:
				$classes[] = 'fluida-magazine-three fluida-magazine-layout';
				break;
		endswitch;
	}
	switch ($options['fluida_comclosed']) {
		case 2:
			$classes[] = 'fluida-comhide-in-posts';
			break;
		case 3:
			$classes[] = 'fluida-comhide-in-pages';
			break;
		case 0:
			$classes[] = 'fluida-comhide-in-posts';
			$classes[] = 'fluida-comhide-in-pages';
	...
	switch ($options['fluida_contenttitles']) {
		case 2:
			$classes[] = 'fluida-hide-page-title';
			break;
		case 3:
			$classes[] = 'fluida-hide-cat-title';
			break;
		case 0:
			$classes[] = 'fluida-hide-page-title';
			$classes[] = 'fluida-hide-cat-title';
	...
	if ($options['fluida_menuheight'] > 70) {
		$classes[] = 'fluida-menu-animation';
	}
...
?>
	...
	$sidebarP = absint($fluida_primarysidebar);
	$sidebarS = absint($fluida_secondarysidebar);
	?>
	...
	#commentform { <?php if ($fluida_comformwidth) {
						echo 'max-width:' . esc_html($fluida_comformwidth) . 'px;';
					} ?>}
	...
	.main p { text-indent: <?php echo floatval($fluida_parindent) ?>em; }
